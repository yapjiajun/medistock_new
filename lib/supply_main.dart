...
class SupplyMainPage extends StatefulWidget {
  ...
  const SupplyMainPage({Key? key}) : super(key: key);

  @override
  _SupplyMainPageState createState() => _SupplyMainPageState();
}

class _SupplyMainPageState extends State<SupplyMainPage> {
                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(context, NewDemandListPage.id);
                          },
                          child: Center(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
